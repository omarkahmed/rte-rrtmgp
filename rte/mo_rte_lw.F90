...
module mo_rte_lw
  ...
  use mo_rte_solver_kernels_add, &
                        only: lw_solver_Tang_GaussQuad, lw_solver_Tip_GaussQuad
  implicit none
  private
