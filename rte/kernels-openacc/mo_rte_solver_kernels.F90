...
contains
  ...
  subroutine lw_solver_noscat(ncol, nlay, ngpt, top_at_1, D, weight,                             &
    ...
    !$acc enter data create(sfc_srcJac, source_sfcJac, radn_upJac)
    !$acc parallel loop collapse(2)
    do igpt = 1, ngpt
      do icol = 1, ncol
    ...
    !$acc exit data delete(sfc_srcJac, source_sfcJac, radn_upJac)
    ...
    if(top_at_1) then
      ...
      do igpt = 1, ngpt
        do icol = 1, ncol
          ...
          radn_upJac(icol,nlay+1,igpt) = radn_dn(icol,nlay+1,igpt)*sfc_albedo(icol,igpt) + source_sfcJac(icol,igpt)
          ! Upward propagation
          do ilev = nlay, 1, -1
      ...
      do igpt = 1, ngpt
        do icol = 1, ncol
          ...
          radn_upJac(icol,     1,igpt) = radn_dn(icol,     1,igpt)*sfc_albedo(icol,igpt) + source_sfcJac(icol,igpt)
          ! Upward propagation
          do ilev = 2, nlay+1
