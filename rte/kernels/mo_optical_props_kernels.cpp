...
void extract_subset_dim1_3d(int ncol, int nlay, int ngpt, real3d const &array_in, int colS, int colE, real3d &array_out) {
  ...
  //   do ilay = 1, nlay
  //     do icol = colS, colE
  parallel_for_cpu_serial( Bounds<3>(ngpt,nlay,{colS,colE}) , YAKL_LAMBDA (int igpt, int ilay, int icol) {
...
void extract_subset_dim2_4d(int nmom, int ncol, int nlay, int ngpt, real3d const &array_in, int colS, int colE, real3d &array_out) {
  ...
  //    do icol = colS, colE
  //      do imom = 1, nmom
  parallel_for_cpu_serial( Bounds<4>(ngpt,nlay,{colS,colE},nmom) , YAKL_LAMBDA (int igpt, int ilay, int icol, int imom) {
