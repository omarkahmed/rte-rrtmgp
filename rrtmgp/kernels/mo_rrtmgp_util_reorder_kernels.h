...
YAKL_INLINE void reorder_123x321_kernel(int d1, int d2, int d3, real3d const &array_in, real3d &array_out) {
  ...
  parallel_for( Bounds<5>({1,d2},{1,ntiles3},{1,ntiles1},{1,TILE_SIZE},{1,TILE_SIZE}) , YAKL_LAMBDA (int const indices[]) {
    int i2, t3, t1, it3, it1;
    storeIndices( indices , i2,t3,t1,it3,it1 );
